...
Write-Host '  2. Pos.App.exe, then Ctrl+D for the owner screen'
Write-Host '  3. Ctrl+4  check the printer, drawer and scale, and look at the bill'
Write-Host '  4. Ctrl+3  add items one at a time, or load a catalogue file'
Write-Host ''
Write-Host '  The pos tool still does all of it from a command line, for support'
Write-Host '  and for a scripted rollout: test-hardware, import-items, receipt-preview.'
Write-Host ''
